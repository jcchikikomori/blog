...
<pre><code class="language-js">import { multiply } from &#39;./answer&#39; // Deprecated: need to restart the experiment
...
<pre><code class="language-js">// Deprecated: This is what you get when you trust a mouse talk show, need to
...
<p>Only JSDoc is enabled by default. Other documentation styles can be enabled with
the <code>import/docstyle</code> setting.</p>
<pre><code class="language-yaml"># .eslintrc.yml
settings:
  import/docstyle: [&#39;jsdoc&#39;, &#39;tomdoc&#39;]
</code></pre>
<h3>Worklist</h3><ul>
<li><input checked="" disabled="" type="checkbox"> report explicit imports on the import node</li>
<li><input checked="" disabled="" type="checkbox"> support namespaces<ul>
<li><input checked="" disabled="" type="checkbox"> should bubble up through deep namespaces (#157)</li>
</ul>
</li>
<li><input checked="" disabled="" type="checkbox"> report explicit imports at reference time (at the identifier) similar to namespace</li>
<li><input checked="" disabled="" type="checkbox"> mark module deprecated if file JSDoc has a @deprecated tag?</li>
<li><input disabled="" type="checkbox"> don&#39;t flag redeclaration of imported, deprecated names</li>
<li><input disabled="" type="checkbox"> flag destructuring</li>
</ul>
