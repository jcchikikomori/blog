...
<pre><code class="language-javascript">// bad4.js

// There is more than one named export in the module.
export * from &#39;./other-module&#39;
</code></pre>
<pre><code class="language-javascript">// bad5.js
...
<pre><code class="language-javascript">// good1.js

// There is only a single module export and it&#39;s a default export.
export default &#39;bar&#39;;
</code></pre>
<pre><code class="language-javascript">// good2.js

// There is only a single module export and it&#39;s a default export.
const foo = &#39;foo&#39;;
export { foo as default }
</code></pre>
<pre><code class="language-javascript">// good3.js

// There is only a single module export and it&#39;s a default export.
export default from &#39;./other-module&#39;;
</code></pre>
<h2>When Not To Use It</h2><p>If you don&#39;t care if named imports are used, or if you prefer named imports over default imports.</p>
