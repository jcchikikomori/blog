...
<a href="https://eslint.org/chat">Chat Room</a></p>
...
<h2><a name="installation-and-usage"></a>Installation and Usage</h2><p>Prerequisites: <a href="https://nodejs.org/">Node.js</a> (<code>^10.12.0</code>, or <code>&gt;=12.0.0</code>) built with SSL support. (If you are using an official Node.js distribution, SSL is always built in.)</p>
...
<h2><a name="configuration"></a>Configuration</h2><p>After running <code>eslint --init</code>, you&#39;ll have a <code>.eslintrc</code> file in your directory. In it, you&#39;ll see some rules configured like this:</p>
...
<h2><a name="code-of-conduct"></a>Code of Conduct</h2><p>ESLint adheres to the <a href="https://eslint.org/conduct">JS Foundation Code of Conduct</a>.</p>
<h2><a name="filing-issues"></a>Filing Issues</h2><p>Before filing an issue, please be sure to read the guidelines for what you&#39;re reporting:</p>
<ul>
...
<h2><a name="faq"></a>Frequently Asked Questions</h2><h3>I&#39;m using JSCS, should I migrate to ESLint?</h3><p>Yes. <a href="https://eslint.org/blog/2016/07/jscs-end-of-life">JSCS has reached end of life</a> and is no longer supported.</p>
...
<h3>Does Prettier replace ESLint?</h3><p>No, ESLint does both traditional linting (looking for problematic patterns) and style checking (enforcement of conventions). You can use ESLint for everything, or you can combine both using Prettier to format your code and ESLint to catch possible errors.</p>
<h3>Why can&#39;t ESLint find my plugins?</h3><ul>
...
<h3>Where to ask for help?</h3><p>Join our <a href="https://groups.google.com/group/eslint">Mailing List</a> or <a href="https://eslint.org/chat">Chatroom</a>.</p>
<h3>Why doesn&#39;t ESLint lock dependency versions?</h3><p>Lock files like <code>package-lock.json</code> are helpful for deployed applications. They ensure that dependencies are consistent between environments and across deployments.</p>
...
<h2><a name="releases"></a>Releases</h2><p>We have scheduled releases every two weeks on Friday or Saturday. You can follow a <a href="https://github.com/eslint/eslint/issues?q=is%3Aopen+is%3Aissue+label%3Arelease">release issue</a> for updates about the scheduling of any particular release.</p>
<h2><a name="security-policy"></a>Security Policy</h2><p>ESLint takes security seriously. We work hard to ensure that ESLint is safe for everyone and that security issues are addressed quickly and responsibly. Read the full <a href="https://github.com/eslint/.github/blob/master/SECURITY.md">security policy</a>.</p>
<h2><a name="semantic-versioning-policy"></a>Semantic Versioning Policy</h2><p>ESLint follows <a href="https://semver.org">semantic versioning</a>. However, due to the nature of ESLint as a code quality tool, it&#39;s not always clear when a minor or major version bump occurs. To help clarify this for everyone, we&#39;ve defined the following semantic versioning policy for ESLint:</p>
<ul>
...
<h2><a name="stylistic-rule-updates"></a>Stylistic Rule Updates</h2><p>Stylistic rules are frozen according to <a href="https://eslint.org/blog/2020/05/changes-to-rules-policies">our policy</a> on how we evaluate new rules and rule changes.
This means:</p>
<ul>
...
<h2><a name="license"></a>License</h2><p><a href="https://app.fossa.io/projects/git%2Bhttps%3A%2F%2Fgithub.com%2Feslint%2Feslint?ref=badge_large"><img src="https://app.fossa.io/api/projects/git%2Bhttps%3A%2F%2Fgithub.com%2Feslint%2Feslint.svg?type=large" alt="FOSSA Status"></a></p>
<h2><a name="team"></a>Team</h2><p>These folks keep the project moving and are resources for help.</p>
<!-- NOTE: This section is autogenerated. Do not manually edit.-->
<!--teamstart-->

<h3>Technical Steering Committee (TSC)</h3><p>The people who manage releases, review feature requests, and meet regularly to ensure ESLint is properly maintained.</p>
...
<h3>Reviewers</h3><p>The people who review and implement new features.</p>
<table><tbody><tr><td align="center" valign="top" width="11%">
...
<h3>Committers</h3><p>The people who review and fix bugs and help triage issues.</p>
<table><tbody><tr><td align="center" valign="top" width="11%">
...
<h2><a name="sponsors"></a>Sponsors</h2><p>The following companies, organizations, and individuals support ESLint&#39;s ongoing maintenance and development. <a href="https://opencollective.com/eslint">Become a Sponsor</a> to get your logo on our README and website.</p>
<!-- NOTE: This section is autogenerated. Do not manually edit.-->
<!--sponsorsstart-->
...
<h2><a name="technology-sponsors"></a>Technology Sponsors</h2><ul>
