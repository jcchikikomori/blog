...
<h2>API</h2><h3>.file(path)</h3><h3>.dir(path)</h3><h3>.symlink(path)</h3><p>Returns a <code>Promise</code> for a <code>boolean</code> of whether the path is the checked type.</p>
<h3>.fileSync(path)</h3><h3>.dirSync(path)</h3><h3>.symlinkSync(path)</h3><p>Returns a <code>boolean</code> of whether the path is the checked type.</p>
