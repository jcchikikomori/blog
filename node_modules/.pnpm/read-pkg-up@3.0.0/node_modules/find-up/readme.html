...
<h2>API</h2><h3>findUp(filename, [options])</h3><p>Returns a <code>Promise</code> for the filepath or <code>null</code>.</p>
<h3>findUp([filenameA, filenameB], [options])</h3><p>Returns a <code>Promise</code> for the first filepath found (by respecting the order) or <code>null</code>.</p>
<h3>findUp.sync(filename, [options])</h3><p>Returns a filepath or <code>null</code>.</p>
<h3>findUp.sync([filenameA, filenameB], [options])</h3><p>Returns the first filepath found (by respecting the order) or <code>null</code>.</p>
<h4>filename</h4><p>Type: <code>string</code></p>
<p>Filename of the file to find.</p>
<h4>options</h4><h5>cwd</h5><p>Type: <code>string</code><br>
