...
<h2>Rule Details</h2><p>This rule warns whenever a single file contains multiple named export declarations or multiple assignments to <code>module.exports</code> (or <code>exports</code>).</p>
<h3>Valid</h3><pre><code class="language-js">// A single named export declaration -&gt; ok
export const valid = true
</code></pre>
<pre><code class="language-js">const first = true
const second = true
...
<pre><code class="language-js">// Aggregating exports -&gt; ok
export { default as module1 } from &#39;module-1&#39;
export { default as module2 } from &#39;module-2&#39;
</code></pre>
<pre><code class="language-js">// A single exports assignment -&gt; ok
module.exports = {
  first: true,
  second: true
}
...
<pre><code class="language-flow">const first = true;
...
<h3>Invalid</h3><pre><code class="language-js">// Multiple named export statements -&gt; not ok!
export const first = true
export const second = true
</code></pre>
<pre><code class="language-js">// Aggregating exports from the same module -&gt; not ok!
export { module1 } from &#39;module-1&#39;
export { module2 } from &#39;module-1&#39;
</code></pre>
<pre><code class="language-js">// Multiple exports assignments -&gt; not ok!
exports.first = true
exports.second = true
</code></pre>
<pre><code class="language-js">// Multiple exports assignments -&gt; not ok!
...
<pre><code class="language-flow">type firstType = boolean
type secondType = any
...
<h2>When Not To Use It</h2><p>If you do not mind having your exports spread across the file, you can safely turn this rule off.</p>
