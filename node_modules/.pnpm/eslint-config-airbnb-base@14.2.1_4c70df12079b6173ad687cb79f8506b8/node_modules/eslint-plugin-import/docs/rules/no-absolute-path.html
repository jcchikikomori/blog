...
<h3>Options</h3><p>By default, only ES6 imports and CommonJS <code>require</code> calls will have this rule enforced.</p>
<p>You may provide an options object providing true/false for any of</p>
<ul>
<li><code>esmodule</code>: defaults to <code>true</code></li>
<li><code>commonjs</code>: defaults to <code>true</code></li>
<li><code>amd</code>: defaults to <code>false</code></li>
</ul>
<p>If <code>{ amd: true }</code> is provided, dependency paths for AMD-style <code>define</code> and <code>require</code>
calls will be resolved:</p>
<pre><code class="language-js">/*eslint import/no-absolute-path: [2, { commonjs: false, amd: true }]*/
