...
<h2>Rule Details</h2><p>This rule runs against <code>import()</code> by default, but can be configured to also run against an alternative dynamic-import function, e.g. &#39;dynamicImport.&#39;
You can also configure the regex format you&#39;d like to accept for the webpackChunkName - for example, if we don&#39;t want the number 6 to show up in our chunk names:</p>
...
<h3>invalid</h3><p>The following patterns are invalid:</p>
<pre><code class="language-javascript">// no leading comment
import(&#39;someModule&#39;);
...
<h3>valid</h3><p>The following patterns are valid:</p>
...
<h2>When Not To Use It</h2><p>If you don&#39;t care that webpack will autogenerate chunk names and may blow up browser caches and bundle size reports.</p>
