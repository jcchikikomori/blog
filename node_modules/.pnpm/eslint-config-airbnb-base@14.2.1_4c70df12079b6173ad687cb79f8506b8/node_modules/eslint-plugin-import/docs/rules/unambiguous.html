...
<p>This plugin uses <a href="https://github.com/nodejs/node-eps/blob/master/002-es-modules.md#32-determining-if-source-is-an-es-module">Unambiguous JavaScript Grammar</a> internally to decide whether
...
<h2>Rule Details</h2><p>For files parsed as <code>module</code> by ESLint, the following are valid:</p>
<pre><code class="language-js">import &#39;foo&#39;
function x() { return 42 }
</code></pre>
<pre><code class="language-js">export function x() { return 42 }
</code></pre>
<pre><code class="language-js">(function x() { return 42 })()
...
<h2>When Not To Use It</h2><p>If your application environment will always know via <a href="https://github.com/nodejs/node-eps/issues/13">some other means</a>
...
<li><a href="https://github.com/nodejs/node-eps/blob/master/002-es-modules.md#32-determining-if-source-is-an-es-module">Unambiguous JavaScript Grammar</a></li>
