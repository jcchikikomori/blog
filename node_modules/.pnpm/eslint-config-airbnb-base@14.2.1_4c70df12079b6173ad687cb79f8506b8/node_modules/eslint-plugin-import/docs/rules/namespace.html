...
<h2>Rule Details</h2><p>Currently, this rule does not check for possible
...
<p>Given:</p>
<pre><code class="language-js">// @module ./named-exports
export const a = 1
const b = 2
export { b }
...
<p>and:</p>
<pre><code class="language-js">// @module ./deep
export const e = &quot;MC2&quot;
</code></pre>
...
<h3>Options</h3><h4><code>allowComputed</code></h4><p>Defaults to <code>false</code>. When false, will report the following:</p>
<pre><code class="language-js">/*eslint import/namespace: [2, { allowComputed: false }]*/
import * as a from &#39;./a&#39;
