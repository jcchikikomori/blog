...
<h2>Options</h2><h3>noUselessIndex</h3><p>If you want to detect unnecessary <code>/index</code> or <code>/index.js</code> (depending on the specified file extensions, see below) imports in your paths, you can enable the option <code>noUselessIndex</code>. By default it is set to <code>false</code>:</p>
<pre><code class="language-js">&quot;import/no-useless-path-segments&quot;: [&quot;error&quot;, {
  noUselessIndex: true,
}]
</code></pre>
<p>Additionally to the patterns described above, the following imports are considered problems if <code>noUselessIndex</code> is enabled:</p>
<pre><code class="language-js">// in my-project/app.js
...
<p>Note: <code>noUselessIndex</code> only avoids ambiguous imports for <code>.js</code> files if you haven&#39;t specified other resolved file extensions. See <a href="https://github.com/benmosher/eslint-plugin-import#importextensions">Settings: import/extensions</a> for details.</p>
<h3>commonjs</h3><p>When set to <code>true</code>, this rule checks CommonJS imports. Default to <code>false</code>.</p>
