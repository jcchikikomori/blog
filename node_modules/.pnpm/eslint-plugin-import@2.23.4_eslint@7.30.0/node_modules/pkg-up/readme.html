...
<h2>API</h2><h3>pkgUp([cwd])</h3><p>Returns a <code>Promise</code> for either the filepath or <code>null</code> if it could be found.</p>
<h3>pkgUp.sync([cwd])</h3><p>Returns the filepath or <code>null</code>.</p>
<h4>cwd</h4><p>Type: <code>string</code>
