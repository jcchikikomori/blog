...
<pre><code class="language-js">// ./baz.js
...
<h3>Settings</h3><p><a href="../../README.md#importignore"><code>import/ignore</code></a> can be provided as a setting to ignore certain modules (node_modules,
CoffeeScript, CSS if using Webpack, etc.).</p>
<p>Given:</p>
<pre><code class="language-yaml"># .eslintrc (YAML)
---
settings:
  import/ignore:
...
<p>and</p>
<pre><code class="language-coffeescript"># ./whatever.coffee
...
<h2>When Not To Use It</h2><p>If you are using CommonJS and/or modifying the exported namespace of any module at
