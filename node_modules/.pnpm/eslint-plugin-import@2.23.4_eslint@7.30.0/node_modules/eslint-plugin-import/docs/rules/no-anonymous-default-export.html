...
<h2>Rule Details</h2><h3>Fail</h3><pre><code class="language-js">export default []
...
<h3>Pass</h3><pre><code class="language-js">const foo = 123
export default foo
