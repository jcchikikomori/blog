...
<p>or since <code>add</code> doesn&#39;t have any imports, it could be in it&#39;s own directory (namespace):</p>
<pre><code>math
└── add.js
three.js
</code></pre>
...
<pre><code class="language-js">import add from &#39;add&#39;; // from https://www.npmjs.com/package/add
export default function three() {
  return add([1,2]);
}
</code></pre>
<p>These are (respectively) static, dynamic &amp; global solutions to graph-like dependency resolution.</p>
<h3>Examples</h3><p>Given the following folder structure:</p>
<pre><code>my-project
├── lib
│   ├── a.js
│   └── b.js
