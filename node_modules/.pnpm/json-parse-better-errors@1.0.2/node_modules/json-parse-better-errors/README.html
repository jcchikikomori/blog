...
<h3>Example</h3><pre><code class="language-javascript">const parseJson = require(&#39;json-parse-better-errors&#39;)
...
<p>Happy hacking!</p>
<h3>API</h3><h4><a name="parse"></a> <code>&gt; parse(txt, ?reviver, ?context=20)</code></h4><p>Works just like <code>JSON.parse</code>, but will include a bit more information when an
error happens.</p>
