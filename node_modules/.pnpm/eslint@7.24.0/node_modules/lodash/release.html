...
<ol>
<li>Clone the two repositories:<pre><code class="language-sh">$ git clone https://github.com/lodash/lodash.git
...
<li>Run:<pre><code class="language-sh">npm run build
npm run doc
