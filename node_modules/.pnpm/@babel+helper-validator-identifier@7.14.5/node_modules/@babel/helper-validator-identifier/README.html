...
<h2>Install</h2><p>Using npm:</p>
<pre><code class="language-sh">npm install --save-dev @babel/helper-validator-identifier
</code></pre>
<p>or using yarn:</p>
<pre><code class="language-sh">yarn add @babel/helper-validator-identifier --dev
</code></pre>
