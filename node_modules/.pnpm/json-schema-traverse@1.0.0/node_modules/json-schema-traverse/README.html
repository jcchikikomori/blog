...
<h2>Install</h2><pre><code>npm install json-schema-traverse
</code></pre>
<h2>Usage</h2><pre><code class="language-javascript">const traverse = require(&#39;json-schema-traverse&#39;);
const schema = {
  properties: {
    foo: {type: &#39;string&#39;},
    bar: {type: &#39;integer&#39;}
...
<h2>Traverse objects in all unknown keywords</h2><pre><code class="language-javascript">const traverse = require(&#39;json-schema-traverse&#39;);
const schema = {
  mySchema: {
    minimum: 1,
    maximum: 2
...
<h2>License</h2><p><a href="https://github.com/epoberezkin/json-schema-traverse/blob/master/LICENSE">MIT</a></p>
