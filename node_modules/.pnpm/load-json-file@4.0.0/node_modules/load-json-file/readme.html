...
<h2>Usage</h2><pre><code class="language-js">const loadJsonFile = require(&#39;load-json-file&#39;);
...
<h2>API</h2><h3>loadJsonFile(filepath)</h3><p>Returns a promise for the parsed JSON.</p>
