...
<h2>Usage</h2><pre><code class="language-js">var globParent = require(&#39;glob-parent&#39;);
...
<h2>API</h2><h3><code>globParent(maybeGlobString, [options])</code></h3><p>Takes a string and returns the part of the path before the glob begins. Be aware of Escaping rules and Limitations below.</p>
<h4>options</h4><pre><code class="language-js">{
  // Disables the automatic conversion of slashes for Windows
  flipBackslashes: true
}
</code></pre>
<h2>Escaping</h2><p>The following characters have special significance in glob patterns and must be escaped if you want them to be treated as regular path characters:</p>
<ul>
...
<h2>Limitations</h2><h3>Braces &amp; Brackets</h3><p>This library attempts a quick and imperfect method of determining which path
...
<h3>Windows</h3><p>Backslashes are not valid path separators for globs. If a path with backslashes
